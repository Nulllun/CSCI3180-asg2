...
public class Map {
	...
	private int m;//Number of monsters
        ...
        private int p;//Number of potions
		...
		for (int i = 0; i < totalNum; i++) {
			...
			if (i < m)
				...
				teleportable_obj.add(this.lands[pos.getX()][pos.getY()].getOccupied_obj());
                                ...
                                // add Potion objects to teleportable obj list
                                this.lands[pos.getX()][pos.getY()].setOccupied_obj(new Potion(pos.getX(), pos.getY(), i-m-e-w, this));
				teleportable_obj.add(this.lands[pos.getX()][pos.getY()].getOccupied_obj());
                        }
		}
	}
		...
		for (Object obj : teleportable_obj) {
		    if (obj instanceof Warrior) {
                    ...
                    if (obj instanceof Potion) {
                                // also teleport the Potion objects
                                ((Potion) obj).teleport();
                    }
		}
	}
