	...
	public void teleport() {
		System.out.println("Hi, " + name + ". " + String.format("Your position is (%d,%d) and health is %d.", this.pos.getX(), this.pos.getY(), this.health));
                ...
                while(true){
                        ...
                        if((posx > 9 || posx < 0)||(posy < 0 || posy > 9)) {
                                System.out.println("Invalid input.");
                                System.out.println("Specify your target position (Input 'x y').");
                                continue;
                        }
		        if((posx == this.pos.getX()) && (posy == this.pos.getY())) {
        ...
        public boolean actionOnWarrior(Warrior warrior) {
                this.talk("Hi, bro. You can call me " + this.getName() + ". I am very happy to meet you. I have " + this.getMagic_crystal() + " magic crystals.");
                ...
                if (a == 1) {
                        int crystals = TheJourney.rand.nextInt(this.getMagic_crystal());
                        // exchange the amount of crystals with other warriors
                        warrior.increaseCrystal(crystals);
                        this.decreaseCrystal(crystals);
                        warrior.talk("Thanks for your shared " + crystals + " magic crystals!  " + this.getName() + "");
                }else{
                        this.talk("See you!");
                }
                // must return false, because the warrior will not occupy others lands
                return false;
        }
